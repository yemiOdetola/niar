...
import { Flower, Flower2, TriangleAlert } from "lucide-react";
    ...
    <Card className="w-full h-full p-8">
      ...
      <CardContent className="space-y-5 px-0 pb-0">
        ...
        <div className="flex flex-col gap-y-2.5">
          ...
          >
            <Flower className="mr-2 size-5 top-2.5 left-2.5 absolute" />
          ...
          <Button
            ...
            className="w-full relative"
          >
            <Flower2 className="mr-2 size-5 top-2.5 left-2.5 absolute" />
